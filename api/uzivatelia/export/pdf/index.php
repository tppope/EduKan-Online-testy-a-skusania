...
foreach ($cely_test['data_testu']['zoznam_pisucich_studentov'] as $student) {
    ...
    $htmlStudentName= '<div>
                <header>
                    <h2>'.$info_about_student['name'].' '.$info_about_student['surname'].'</h2>
                </header>
             ';
     ...
     foreach($cely_test['data_testu']['otazky'] as $key=>$otazky)
     {
         ...
         if($typ_otazky == 4){
             ...
             if(str_contains($spravne_zadane_odpovede_4,"inFiles-")){
                 ...
                 $htmlStudentName.='<div align="center"><img src="../../testy/uploadedImages/'.$path.'" alt="Math_obrazok" height="250px" width="250px" />  </div>';
             }else{
                 ...
                 $htmlStudentName.= '<div align="center"><img src="images/'.$key.'_'.$student_id.'_'.$kluc.'.png" alt="Math_obrazok" height="400" width="400" />  </div>';
